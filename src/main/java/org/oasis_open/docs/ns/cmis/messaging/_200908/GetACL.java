...
public class GetACL {
    ...
    @XmlElementRef(name = "onlyBasicPermissions", namespace = "http://docs.oasis-open.org/ns/cmis/messaging/200908/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> onlyBasicPermissions;
     ...
     *     
     */
    public JAXBElement<Boolean> getOnlyBasicPermissions() {
     ...
     *     
     */
    public void setOnlyBasicPermissions(JAXBElement<Boolean> value) {
